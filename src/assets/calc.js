...
export var lookupWeapon = [
    ...
    {name: "Feral Claws",         wsm:-20, type:1, classItem: 1, weaponCategory:0, canZeal:true,  commonItems: [{title: "Firelizard's Talons", quality: qualities.unique}]},
    ...
    {name: "Greater Talons",      wsm:-30, type:1, classItem: 1, weaponCategory:0, canZeal:true,  commonItems: [{title: "Bartuc's Cut-Throat", quality: qualities.unique}]},
    ...
    {name: "Scissors Suwayyah",   wsm:  0, type:1, classItem: 1, weaponCategory:0, canZeal:true,  commonItems: [{title: "Natalya's Mark", quality: qualities.set}]},
    ...
    {name: "Wrist Sword",         wsm:-10, type:1, classItem: 1, weaponCategory:0, canZeal:true,  commonItems: [{title: "Jade Talon", quality: qualities.unique}]},
    {name: "Yari",                wsm:  0, type:5, classItem:-1, weaponCategory:8, canZeal:true,  commonItems: [{title: "Hone Sundan", quality: qualities.unique}]},
